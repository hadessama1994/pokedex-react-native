...
import {
  Container, Text, Header, Content, List, ListItem, Left, Body, Right, Thumbnail, Badge, Grid, Col, Spinner, H3,
} from 'native-base';
          ...
          <Body>
            <Grid>
              ...
              <Left style={{ flex: 3.0 }}>
                ...
                <Col>
                  <H3 style={{ alignSelf: 'center', paddingLeft: 10 }}>
                    {' '}
              ...
              <Right style={{ flex: 1.0 }}>
                <Col style={{ justifyContent: 'flex-end' }}>
                  <Badge style={{ backgroundColor: `${color1}` }}><Text>{pokeType.toUpperCase()}</Text></Badge>
                  <Badge style={{ backgroundColor: `${color2}` }}><Text>{pokeType2.toUpperCase()}</Text></Badge>
                </Col>
              </Right>
